...
function Contact() {
    ...
    const sendMsg = (e) => {
        ...
        emailjs.send('service_vv8vb8h', 'template_oh2ppjm', emailData, 'aY3ghhuJryrcgslCE')
          .then((response) => {
                    ...
                    <div className=" flex flex-col justify-evenly w-[80%] md:w-[35%] h-[55vh] md:h-[65vh] text-white p-5 ">
                        ...
                        <div data-aos="zoom-in" className="h-[100%] w-[95%] flex items-center">
                            ...
                            <h1 className="text-gray-400">MAIL US</h1>
                                <h1 className="text-white font-serif text-sm md:text-md">faizaliabdulhameed@</h1>
                            </div>
                        </div>
                        <div data-aos="zoom-in" className="h-[100%] w-[95%] flex items-center">
                            <div className="spain1 flex justify-center items-center w-[40%] h-[10vh]  rounded-3xl">
                            ...
                            <div className="flex flex-col justify-center p-2 w-full">
                                ...
                                <h1 className="text-white font-serif text-sm md:text-md">+92307 0451883</h1>
                            </div>
                        </div>
                        <div data-aos="zoom-in" className="h-[100%] w-[95%] flex items-center">
                            <div className="spain1 flex justify-center items-center w-[40%] h-[10vh] rounded-3xl">
                            ...
                            <div className="flex flex-col justify-center p-2 w-full">
                                ...
                                <h1 className="text-white font-serif text-sm md:text-md">ashrafi street no 22 , House  1/C Pakistan</h1>
                            </div>
                        </div>
                        <div data-aos="zoom-in" className="h-[100%] w-[95%] flex items-center">
                            <div className="spain1 flex justify-center items-center w-[40%] h-[10vh] rounded-3xl">
