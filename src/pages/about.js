            ...
            <div className=' md:w-[88%] h-[100%] flex flex-wrap justify-center  md:flex md:justify-between'> 
               ...
               <div className="w-[100%] md:w-[65%] mt-2 h-[100%]  flex flex-col items-center">
                    ...
                    <div data-aos="fade-down" className="spain1 p-5 rounded-3xl w-[80%] md:w-[100%] mt-2 h-[100%]  text-white ">
                        ...
                        <h1 className=' text-white font-semibold font-[Inter, sans-serif] text-3xl md:text-5xl mt-4   '>FAIZ ALI</h1>
                ...
                <div data-aos="zoom-in" className="spain1 mt-4 md:flex md:justify-between   flex flex-col justify-between  bg-[#1E1E1E] md:h-[45vh] h-[45vh] md:w-[49%] w-[80%] text-white p-5 rounded-3xl">
                    <div className="md:h-[100%] h-[100%]  w-full flex flex-col  ">
                      ...
                      <p className="font-semibold text-lg tracking-wide text-gray-400">Typhone Tech,</p>
                ...
                <div data-aos="zoom-in" className="spain1 mt-4 md:flex md:justify-between   flex flex-col justify-between  bg-[#1E1E1E] md:h-[45vh] h-[45vh] md:w-[49%] w-[80%] text-white p-5 rounded-3xl">
                    <div className="md:h-[100%] h-[100%]  w-full flex flex-col  ">
                      ...
                      <p className="font-semibold text-gray-400 tracking-wide mt-4 text-lg">2018 - 2019</p>
                      <h1 className="font-semibold text-lg tracking-wide">Science</h1>
                      <p className="font-semibold text-lg tracking-wide text-gray-400">City District Government Boys High School</p>
                      <h1 className="font-semibold text-lg tracking-wide text-gray-400 mt-5">2020 - 2021</h1>
                      <p className="font-semibold text-lg tracking-wide">F.S.C (pre Eng) </p>
                      <h1 className="text-gray-400 text-lg tracking-wide font-semibold">Shalimar College</h1>
                    </div>
                </div>
                ...
                <h1 className='text-center w-[100%] text-white mt-5'>© All rights reserved by <span className='text-purple-600'> FAIZ ALI </span> </h1>
           </div>
        </div>
        </>
    )
