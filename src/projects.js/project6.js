...
import pro1 from "../images/pro5.png"
import Aos from "aos";
        ...
        <div className="w-full bg-black pt-14 pb-14 flex justify-center items-center">
            <div className=' md:w-[88%] h-[100%] flex flex-wrap justify-center  md:flex md:justify-between'> 
                ...
                <div data-aos="zoom-in" className="spain1 flex flex-col justify-around mt-4 md:mt-0 w-[70%] md:w-[48%] text-white md:h-[90vh] p-7 rounded-3xl">
                    <h1 className="text-gray-400">PROJECT :<spna className="text-white text-ellipsis md:ml-5 md:text-lg font-serif">Animation theme</spna></h1>
                    <h1 className="text-gray-400 mt-2 md:mt-0 ">DETAILS :<spna className="text-white md:ml-5 font-serif">The project I worked on involved creating a captivating animation-themed website using a combination of HTML, CSS, React, JavaScript, Tailwind, and Animation libraries.The main goal was to develop an engaging user interface and enhances the overall user experience.</spna></h1>
                    <h1 className="text-gray-400 mt-2 md:mt-0">Technologies :<spna className="text-white md:ml-5 md:text-lg font-serif">Html,css,React,javascript,Tailwend,Animation</spna></h1>
                    ...
                    <h1 className="text-gray-400 mt-2 md:mt-0">URL :<a className="text-blue-500 text-sm md:text-lg md:ml-5" href="https://mrfaiz123.github.io/react-tailwind-template-/">https://mrfaiz123.github.io/react-tailwind-template-/ </a></h1>
